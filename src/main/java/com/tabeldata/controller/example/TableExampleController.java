package com.tabeldata.controller.example;
...
import com.tabeldata.mappers.example.TableExampleMapper;
import com.tabeldata.service.example.TableExampleService;
...
public class TableExampleController {
    ...
    public ResponseEntity<?> createPost(@RequestBody @Valid TableExampleDto.New dto) {
        TableExample value = TableExampleMapper.Create.converter.convertToEntity(dto);
    ...
    public ResponseEntity<?> updatePostById(@RequestBody @Valid TableExampleDto.Update dto) {
        TableExample value = TableExampleMapper.Update.converter.convertToEntity(dto);
